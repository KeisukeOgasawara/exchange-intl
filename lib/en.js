...
export default {
  ...
  "account": {
    ...
    "withdrawable-margin": "Withdrawable Margin",
  ...
  "error": {
    ...
    "order-price-bigger-than-min": "Order price must be larger than 0",
    ...
    "order-quantity-min-ETH": "Order quantity must be bigger than 0.5 ETH",
    "order-quantity-min-BTC": "Order quantity must be bigger than 0.01 BTC",
    "order-quantity-max-ETH": "Order quantity must be smaller than 1000 ETH",
    "order-quantity-max-BTC": "Order quantity must be smaller than 100 BTC",
  ...
  "manage-fund": {
    "button-text": "MANAGE FUND",
    "modal-title": "Manage Futures Funding",
    "btc-account": "BTC Account",
    "futures-account": "Futures Account",
    "quantity": "Quantity",
    "quantity-lesser-than-btc-account-balance": "Quantity must be lesser than BTC account's balance",
    "quantity-lesser-than-futures-account-balance": "Quantity must be lesser than Futures account's balance",
    "transfer-success": "Transfer successfully",
